...
var config = envVarsSchema.parse(process.env);
export default config;
export var DB_URL = "postgres://".concat(config.DB_USER, ":").concat(config.DB_PASSWORD, "@localhost:").concat(config.DB_PORT, "/").concat(config.DB_NAME);
